  ...
  function MessageResponse({
    ...
    const components = React.useMemo(() => {
      ...
      const renderHeading = (
        ...
        const anchorId = buildMarkdownHeadingAnchorId(text, headingIdMap, headingIdPrefix)
        const headingClassName = cn('scroll-mt-20', props.className)

        switch (level) {
          case 1:
            return <h1 {...props} id={anchorId} data-heading-id={anchorId} className={headingClassName} />
          case 2:
            return <h2 {...props} id={anchorId} data-heading-id={anchorId} className={headingClassName} />
          case 3:
            return <h3 {...props} id={anchorId} data-heading-id={anchorId} className={headingClassName} />
          case 4:
            return <h4 {...props} id={anchorId} data-heading-id={anchorId} className={headingClassName} />
          case 5:
            return <h5 {...props} id={anchorId} data-heading-id={anchorId} className={headingClassName} />
          default:
            return <h6 {...props} id={anchorId} data-heading-id={anchorId} className={headingClassName} />
        }
      }

      return {
        h1: (props: React.HTMLAttributes<HTMLHeadingElement>) => renderHeading(1, props),
        h2: (props: React.HTMLAttributes<HTMLHeadingElement>) => renderHeading(2, props),
        h3: (props: React.HTMLAttributes<HTMLHeadingElement>) => renderHeading(3, props),
        h4: (props: React.HTMLAttributes<HTMLHeadingElement>) => renderHeading(4, props),
        h5: (props: React.HTMLAttributes<HTMLHeadingElement>) => renderHeading(5, props),
        h6: (props: React.HTMLAttributes<HTMLHeadingElement>) => renderHeading(6, props),
        a: MarkdownLink,
        pre: MarkdownPre,
    ...
    }, [basePath, children, headingIdPrefix])
